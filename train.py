...
BATCH_SIZE = 16
WEIGHT_DECAY = 0  # eğer bütün model eğitilecekse düşürülmeli ama şu anda gerek yok overfit oluyor bu şekilde
EPOCH = 100
NUM_WORKERS = 2 
PIN_MEMORY = True
LOAD_MODEL = False
LOAD_MODEL_FILE = "overfit.pth.tar"
IMG_DIR ="..\\..\\ML\\data\\images"
LABEL_DIR ="..\\..\\ML\\data\\labels"
...
def main():
    ...
    train_dataset = VOCDataset(
        "..\\..\\ML\\data/8examples.csv",img_dir=IMG_DIR, label_dir= LABEL_DIR, transform=transform
        )

    test_dataset = VOCDataset(
        "..\\..\\ML\\data/test.csv",img_dir=IMG_DIR, label_dir= LABEL_DIR, transform=transform
        )
